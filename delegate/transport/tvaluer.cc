...
TValueR::TValueR(CSPCTrans trans, const QHash<Section, const SectionRule*>* section_rule_hash, bool is_value, QObject* parent)
...
void TValueR::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
...
QSize TValueR::sizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const
{
    auto value { index.data().toDouble() };
...
int TValueR::GetDecimal(const QModelIndex& index) const
{
