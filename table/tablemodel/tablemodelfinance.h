...
class TableModelFinance final : public AbstractTableModel {
    Q_OBJECT

public:
    TableModelFinance(const Info* info, const SectionRule* section_rule, QSharedPointer<Sql> sql, int node_id, bool node_rule, QObject* parent = nullptr);
    ~TableModelFinance() override;
...
private:
    ...
    bool UpdateFXRate(SPTrans& trans, double value);
