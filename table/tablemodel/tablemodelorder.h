...
class TableModelOrder final : public AbstractTableModel {
    Q_OBJECT

public:
    TableModelOrder(const Info* info, const SectionRule* section_rule, QSharedPointer<Sql> sql, int node_id, bool node_rule, QObject* parent = nullptr);
