...
class TransportModel : public QAbstractItemModel {
    Q_OBJECT
public:
    TransportModel(CStringList* table_header, const QHash<Section, QSharedPointer<Sql>>* table_sql_hash, QObject* parent = nullptr);
    ~TransportModel();
...
private:
    ...
    const QHash<Section, QSharedPointer<Sql>>* table_sql_hash_ {};
